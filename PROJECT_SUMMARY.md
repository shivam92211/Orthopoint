# Orthopaedic Instruments Store - Project Summary

## Project Overview

A complete full-stack e-commerce website for selling orthopaedic instruments with an admin panel for managing inventory.
